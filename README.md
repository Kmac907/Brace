...
Each script is resumable. Tasks and bugs run in isolated external Git worktrees and integrate through real GitHub or Azure DevOps pull requests.
...
The scripts print clear stage status and write local summaries under `.codex/`.
